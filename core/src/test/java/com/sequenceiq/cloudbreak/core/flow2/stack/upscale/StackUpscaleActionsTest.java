...
//        Assertions.assertEquals(ADJUSTMENT_ZERO, variables.get(AbstractStackUpscaleAction.HOST_GROUP_WITH_ADJUSTMENT));
//        Assertions.assertEquals(Set.of("hostname"), variables.get(HOST_GROUP_WITH_HOSTNAMES));
