...
public class CcmUpgradeService {
    ...
    void prepareCcmUpgradeOnCluster(Long stackId) {
        String statusReason = "Preparing cluster management change of the cluster.";
    ...
    void ccmUpgradeFinished(Long stackId) {
        String statusReason = "Cluster manager upgrade finished.";
        LOGGER.debug(statusReason);
    ...
    void ccmUpgradeFailed(Long stackId) {
        String statusReason = "Cluster manager upgrade failed.";
        LOGGER.debug(statusReason);
