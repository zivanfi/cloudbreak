    ...
    public Action<?, ?> collectCandidatesAction() {
        return new AbstractClusterAction<>(ClusterDownscaleTriggerEvent.class) {
            ...
            protected void doExecute(ClusterViewContext context, ClusterDownscaleTriggerEvent payload, Map<Object, Object> variables) {
                ...
                clusterDownscaleService.clusterDownscaleStarted(context.getStackId(), payload.getHostGroupWithAdjustment(),
                        payload.getHostGroupWithPrivateIds(), payload.getDetails());
                CollectDownscaleCandidatesRequest request = new CollectDownscaleCandidatesRequest(context.getStackId(), payload.getHostGroupWithAdjustment(),
                        payload.getHostGroupWithPrivateIds(), payload.getDetails());
