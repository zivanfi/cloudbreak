...
public class SdxRecoverySelectorServiceTest {
    ...
    public void setResizeTest() {
        lenient().when(mockResizeRecoveryService.canRecover(any())).thenReturn(true);
        lenient().when(mockSdxUpgradeRecoveryService.canRecover(any())).thenReturn(false);
    ...
    public void setUpgradeTest() {
        lenient().when(mockResizeRecoveryService.canRecover(any())).thenReturn(false);
        lenient().when(mockSdxUpgradeRecoveryService.canRecover(any())).thenReturn(true);
    ...
    public void testRecoveryServiceCanValidateUpgradeFailureByClusterName() {
        ...
        // Basically, just check that we pass through
        Mockito.verify(mockSdxUpgradeRecoveryService).validateRecovery(cluster);
        Mockito.verify(mockResizeRecoveryService, never()).validateRecovery(cluster);
